        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6 fixed">
                <ul class="cabinet_menu">
                    ...
                    <li><a href="personal.php">Пропуск на персонал</a></li>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-6 margin_fixed">
                <div class="main_text"><span>С</span>отрудники, допущенные на территорию организации</div>
                ...
                <div class="row">
                    ...
                    $personalinfo = mysqli_query($connect, 'SELECT personal.ID_personal, personal.familiya, personal.imya, personal.otchestvo FROM personal, user WHERE personal.ID_user=user.ID_user and user.nomer_dogovora = "'.$_SESSION['login'].'"');

                    $i = 1;
                    while ($row = mysqli_fetch_assoc($personalinfo)) {

                        echo '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">';
                        echo ' <div class="car_block">';
                        echo ' <div class="row_name_main">Сотрудник №'.$i.'</div>';
                        echo ' <div class="row car_row">';
                        echo ' <div class="col-lg-4 col-md-3 col-sm-1 col-xs-6 row_name">Фамилия:</div>';
                        echo ' <div class="col-lg-8 col-md-3 col-sm-1 col-xs-6 row_value_sotrudnik">'.$row['familiya'].'</div>';
                        echo ' </div>';
                        echo ' <div class="row car_row">';
                        echo '<div class="col-lg-4 col-md-3 col-sm-1 col-xs-6 row_name">Имя:</div>';
                        echo '<div class="col-lg-8 col-md-3 col-sm-1 col-xs-6 row_value_sotrudnik">'.$row['imya'].'</div>';
                        echo '</div>';
                        echo '<div class="row car_row">';
                        echo '<div class="col-lg-4 col-md-3 col-sm-1 col-xs-6 row_name">Отчество:</div>';
                        echo '<div class="col-lg-8 col-md-3 col-sm-1 col-xs-6 row_value_sotrudnik">'.$row['otchestvo'].'</div>';
                        echo '</div>';
                        echo '<div class="delete_button">';
                        echo '<form method="post" action = "personal_func.php"><button class="button" name="delete_personal" value="'.$row['ID_personal'].'"">Удалить</button></form>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                        <div class="car_block_add">
                            <form action="personal_func.php" method="post">
                                <div class="row_name_main">Новый сотрудник</div>
                                <div class="row car_row">
                                    ...
                                    <div class="col-lg-8 col-md-3 col-sm-1 col-xs-6 row_value_add">
                                        <input type="text" name="familiya" id="familiya" required />
                                    </div>
                                </div>
                                <div class="row car_row">
                                    <div class="col-lg-4 col-md-3 col-sm-1 col-xs-6 row_name_add">
                                ...
                                <div class="delete_button">
                                    <button type="submit" class="save_personal button" name="add_personal">Сохранить</button>
                                </div>
                            </form>
                        </div>
                    </div>
